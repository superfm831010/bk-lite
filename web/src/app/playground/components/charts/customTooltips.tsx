...
import { getEnumValue } from '@/app/playground/utils/common';
import { formatProbability } from '@/app/playground/utils/common';
import { MetricItem } from '@/app/playground/types';
        ...
        {sortedPayload.map((item: any, index: number) => (
          <div key={index}>
            <div className="flex items-center mt-[4px]">
              ...
              {item.payload?.anomaly_probability !== undefined && (
                <span className="font-[600] ml-[10px] text-red-500">
                  异常概率: {formatProbability(item.payload.anomaly_probability)}
                </span>
              )}
            </div>
