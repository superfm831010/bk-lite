      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-4">
          ...
          >
            <Radio.Button value="month">
              {t('log.event.heatMap.monthDisplay')}
            </Radio.Button>
            <Radio.Button value="day">
              {t('log.event.heatMap.dayDisplay')}
            </Radio.Button>
          </Radio.Group>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <DatePicker
            ...
            placeholder={
              viewMode === 'month'
                ? t('log.event.heatMap.selectMonth')
                : t('log.event.heatMap.selectDate')
            }
            allowClear={false}
            ...
            if (viewMode === 'month') {
              ...
              tooltipTitle = (
                <div>
                  <div>{dateStr}</div>
                  <div>
                    {t('log.event.heatMap.quantity')}：{cellData.count}
                  </div>
                </div>
              );
            } else {
