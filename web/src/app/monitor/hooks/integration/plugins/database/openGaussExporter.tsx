...
import { useOpenGaussExporterFormItems } from '../../common/openGaussExporterFormItems';
import { cloneDeep } from 'lodash';

export const useOpenGaussExporter = () => {
  const { t } = useTranslation();
  const openGaussExporterFormItems = useOpenGaussExporterFormItems();
  const pluginConfig = {
    collect_type: 'exporter',
    config_type: ['opengauss'],
    collector: 'OpenGauss-Exporter',
    instance_type: 'opengauss',
    object_name: 'OpenGauss',
  };
  ...
  return {
    getPluginCfg: (extra: {
      ...
      const formItems = (
        <>
          {openGaussExporterFormItems.getCommonFormItems()}
      ...
      const config = {
        auto: {
          formItems: openGaussExporterFormItems.getCommonFormItems('auto'),
          initTableItems: {
