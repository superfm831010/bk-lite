...
import { useKingBaseExporterFormItems } from '../../common/kingBaseExporterFormItems';
import { cloneDeep } from 'lodash';

export const useKingBaseExporter = () => {
  const { t } = useTranslation();
  const kingBaseExporterFormItems = useKingBaseExporterFormItems();
  const pluginConfig = {
    collect_type: 'exporter',
    config_type: ['kingbase'],
    collector: 'KingBase-Exporter',
    instance_type: 'kingbase',
    object_name: 'kingbase',
  };
  ...
  return {
    getPluginCfg: (extra: {
      ...
      const formItems = (
        <>
          {kingBaseExporterFormItems.getCommonFormItems()}
      ...
      const config = {
        auto: {
          formItems: kingBaseExporterFormItems.getCommonFormItems('auto'),
          initTableItems: {
