    ...
    getCommonFormItems: (mode?: 'manual' | 'auto' | 'edit') => {
      return (
        <>
          ...
          <Form.Item label={t('monitor.integrations.dbTimeout')} required>
            <Form.Item
              noStyle
            ...
            <span className="text-[12px] text-[var(--color-text-3)]">
              {t('monitor.integrations.dbTimeoutDes')}
            </span>
          </Form.Item>
          ...
          <Form.Item label={t('monitor.integrations.dataType')} required>
            <Form.Item
              noStyle
              name="data_type"
              rules={[
            ...
            <span className="text-[12px] text-[var(--color-text-3)]">
              {t('monitor.integrations.dataTypeDes')}
            </span>
          </Form.Item>
        </>
      );
