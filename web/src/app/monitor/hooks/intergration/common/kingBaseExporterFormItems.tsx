...
const useKingBaseExporterFormItems = () => {
    ...
    getCommonFormItems: (mode?: 'manual' | 'auto' | 'edit') => {
      return (
        <>
          ...
          <Form.Item label={t('monitor.intergrations.dbTimeout')} required>
            <Form.Item
              noStyle
              name={`${mode === 'auto' ? 'ENV_' : ''}SQL_EXPORTER_TIMEOUT`}
              rules={[
                {
                  required: true,
                  message: t('common.required'),
            ...
            <span className="text-[12px] text-[var(--color-text-3)]">
              {t('monitor.intergrations.dbTimeoutDes')}
            </span>
          </Form.Item>
          ...
          <Form.Item label={t('monitor.intergrations.dataType')} required>
            <Form.Item
              noStyle
              name="data_type"
              rules={[
            ...
            <span className="text-[12px] text-[var(--color-text-3)]">
              {t('monitor.intergrations.dataTypeDes')}
            </span>
          </Form.Item>
        </>
      );
...
export { useKingBaseExporterFormItems };
