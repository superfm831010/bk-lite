...
import { useMssqlFormItems } from '../../common/mssqlFormItems';
...
export const useMssqlTelegraf = () => {
  const { t } = useTranslation();
  const mssqlFormItems = useMssqlFormItems();
  const pluginConfig = {
  ...
  return {
    getPluginCfg: (extra: {
      ...
      const formItems = (
        <>
          {mssqlFormItems.getCommonFormItems(disabledForm)}
