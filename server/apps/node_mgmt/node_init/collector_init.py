...
COLLECTORS = [
    ...
    },
    {
        ...
        "execute_parameters": "--host $HOST --port $PORT --web.listen-address 127.0.0.1:$LISTEN_PORT --isASM --isRAC --isArchiveLog --isDataGuard",
        "validation_parameters": "",
        "default_template": "",
    ...
    {
        "id": "exporter_apache_linux",
        "name": "Apache-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/apache_exporter",
        "execute_parameters": "--web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Apache Exporter is a monitoring tool that collects and exports Apache HTTP server metrics, providing insights into web server performance and health."
    },
    {
        "id": "exporter_elasticsearch_linux",
        "name": "Elasticsearch-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/elasticsearch_exporter",
        "execute_parameters": "--es.uri $ES_URI --web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Elasticsearch Exporter is a monitoring tool that collects and exports Elasticsearch metrics, providing insights into search engine performance and health."
    },
    {
        "id": "exporter_kafka_linux",
        "name": "Kafka-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/kafka_exporter",
        "execute_parameters": "--kafka.server $KAFKA_SERVER --sasl.enabled --web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Kafka Exporter is a monitoring tool that collects and exports Kafka metrics, providing insights into message broker performance and health."
    },
    {
        "id": "exporter_mongodb_linux",
        "name": "Mongodb-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/mongodb_exporter",
        "execute_parameters": "--mongodb.host $MONGODB_HOST --mongodb.port $MONGODB_PORT --web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Mongodb Exporter is a monitoring tool that collects and exports MongoDB metrics, providing insights into database performance and health."
    },
    {
        "id": "exporter_mssql_linux",
        "name": "Mssql-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/mssql_exporter",
        "execute_parameters": "--web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Mssql Exporter is a monitoring tool that collects and exports Microsoft SQL Server metrics, providing insights into database performance and health."
    },
    {
        "id": "exporter_mysql_linux",
        "name": "Mysql-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/mysql_exporter",
        "execute_parameters": "--mysqld.host $MYSQL_HOST --mysqld.port $MYSQL_PORT --web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Mysql Exporter is a monitoring tool that collects and exports MySQL metrics, providing insights into database performance and health."
    },
    {
        "id": "exporter_nginx_linux",
        "name": "Nginx-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/nginx_exporter",
        "execute_parameters": "--web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Nginx Exporter is a monitoring tool that collects and exports Nginx server metrics, providing insights into web server performance and health."
    },
    {
        "id": "exporter_rabbitmq_linux",
        "name": "Rabbitmq-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/rabbitmq_exporter",
        "execute_parameters": "--web.listen-address 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Rabbitmq Exporter is a monitoring tool that collects and exports RabbitMQ metrics, providing insights into message broker performance and health."
    },
    {
        "id": "exporter_zookeeper_linux",
        "name": "Zookeeper-Exporter",
        "controller_default_run": False,
        "icon": "",
        "node_operating_system": "linux",
        "service_type": "exec",
        "executable_path": "/opt/fusion-collectors/bin/zookeeper_exporter",
        "execute_parameters": "--zk-hosts $ZK_HOSTS --listen 127.0.0.1:$LISTEN_PORT",
        "validation_parameters": "",
        "default_template": "",
        "introduction": "Zookeeper Exporter is a monitoring tool that collects and exports Zookeeper metrics, providing insights into distributed coordination service performance and health."
    }
]
