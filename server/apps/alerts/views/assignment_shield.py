...
# @Author: windyzhao
from apps.alerts.filters import AlertAssignmentModelFilter
from apps.alerts.serializers.serializers import AlertAssignmentModelSerializer
from config.drf.pagination import CustomPageNumberPagination
from config.drf.viewsets import ModelViewSet
from apps.alerts.models import AlertAssignment, AlertReminderTask
        ...
        try:
            ...
            for reminder in active_reminders:
                ...
                if not level_config or level_config.get('interval_minutes', 0) <= 0:
                    ...
                    logger.info(f"更新级别为 {alert_level} 的告警 {reminder.alert.alert_id} 的提醒配置: 频率={new_frequency}分钟, 最大次数={new_max_count}")
