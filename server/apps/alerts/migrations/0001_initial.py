# Generated by Django 4.2.7 on 2025-05-22 08:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="event",
            index=django.contrib.postgres.indexes.GinIndex(fields=["search_vector"], name="event_search_gin"),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="alert",
            index=django.contrib.postgres.indexes.GinIndex(fields=["search_vector"], name="alert_search_gin"),
        ),
    ]
