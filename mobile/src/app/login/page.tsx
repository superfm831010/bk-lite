  ...
  const renderPasswordResetForm = () => (
    <div className="text-center space-y-4">
      <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
        <LockOutline fontSize={32} className="text-orange-600" />
      </div>
  ...
  const renderOtpVerificationForm = () => (
    <div className="text-center space-y-4">
      <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
        <LockOutline fontSize={32} className="text-blue-600" />
      </div>
      <h3 className="text-lg font-semibold text-gray-900">
            ...
            {formError && (
              <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-3 rounded-lg mb-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="font-medium text-sm">{formError}</div>
                </div>
              </div>
            )}
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  {loadingDomains ? (
                    ...
                    <div
                      className="flex items-center justify-between w-full h-9 px-3 bg-gray-50 rounded-lg border border-gray-100 cursor-pointer hover:bg-gray-100 transition-colors"
                      onClick={() => setShowDomainSelector(true)}
                    >
                      <div className="flex items-center space-x-2.5">
                        <GlobalOutline className="text-gray-400 text-sm" />
                  ...
                  {!loadingDomains && domainList.length === 0 && (
                    <div className="text-amber-600 text-xs bg-amber-50 border border-amber-200 px-2.5 py-1.5 rounded-lg">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <UserOutline className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 z-10 text-sm" />
                    <Input
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <LockOutline className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 z-10 text-sm" />
                    <Input
                    ...
                    >
                      {showPassword ? (
                        <EyeOutline className="text-sm" />
                      ) : (
                        <EyeInvisibleOutline className="text-sm" />
                      )}
                    </button>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="w-full h-9 rounded-lg shadow-sm mt-4"
                  style={{
                    backgroundColor:
