...
class BaseAnomalyDetection(abc.ABC):
    ...
    def _prepare_hyperopt_config(self, hyperopt_config: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        merged_space = {**self.get_default_hyperopt_config(),
    ...
    def train(
        ...
        logger.info(
            f"🔍 开始训练任务: {task_id}，实验: {experiment_name},mlflow_tracking_uri:{core_settings.mlflow_tracking_uri}")
        ...
        def objective(params: Dict[str, Any]) -> Dict[str, Any]:
            ...
            model = self.build_model(converted_params)
    ...
    @abc.abstractmethod
    def get_default_hyperopt_config(self) -> Dict[str, Any]:
        """获取默认的超参数优化配置，由子类实现"""
        pass

    @abc.abstractmethod
    def build_model(self, train_params: Dict[str, Any]) -> Any:
        """构建模型，由子类实现"""
        pass
